...
This material is licensed by Sergi Mansilla <sergi.mansilla@gmail.com>
under the Creative Commons Attribution-ShareAlike 3.0 license. You are
free to copy, distribute, transmit, and remix this work, provided you
attribute the work to Sergi Mansilla as the original author and
reference this repository (https://github.com/sergi/jsmidi). If you
alter, transform, or build upon this work, you may distribute the
resulting work only under the same, similar or compatible license. Any
of the above conditions can be waived if you get permission from the
copyright holder. For any reuse or distribution, you must make clear
to others the license terms of this work. The best way to do this is
with a link to the Creative Commons Attribution-Share Alike 3.0
        ...
        return {
            ...
            save: function() {
                window.open("data:audio/midi;base64," + this.b64,
                            ...
                            "resizable=yes,scrollbars=no,status=no,height=100,width=400");
            }
        };
